...
(function(){
  ...
  const CARS = [
    ...
    { id:'supra',                  brand:'Toyota',      name:'GR Supra',                   tier:'sportive', price:16000,  model:'uploads/toyota_supra_dekztrax_34.glb',       rotY:Math.PI, glow:0xff6a00, body:0x140806, stats:{speed:6.5,  accel:6.8, handling:7.8, boost:6} },
    ...
    { id:'porsche-911',            brand:'Porsche',     name:'911 Turbo S',                tier:'sportive', price:34000,  model:'uploads/2021_porsche_911_turbo_s_992.glb',   rotY:0, glow:0xc9d3da, body:0x101215, stats:{speed:8.1,  accel:8.6, handling:8.2, boost:7.4} },
    ...
    { id:'812-competizione',       brand:'Ferrari',     name:'812 Competizione',           tier:'hypercar', price:82000,  model:'uploads/ferrari-812-competizione.glb',       rotY:0, glow:0xff1a1a, body:0x140505, stats:{speed:8.7,  accel:9,   handling:9,   boost:9} },
    { id:'aston-one77',            brand:'Aston Martin', name:'One-77',                    tier:'hypercar', price:60000,  model:'uploads/2010_aston_martin_one-77.glb',       rotY:Math.PI/2, glow:0x2f8f5c, body:0x0a0f0c, stats:{speed:8.8,  accel:8.8, handling:8.3, boost:8.7} },
    ...
    { id:'pagani-imola',           brand:'Pagani',      name:'Imola',                      tier:'hypercar', price:210000, model:'uploads/2021_pagani_imola.glb',              rotY:0, glow:0x3dd94f, body:0x0a1408, stats:{speed:9.3,  accel:9.5, handling:8.8, boost:9.7} },
    { id:'mclaren-p1',             brand:'McLaren',     name:'P1',                         tier:'hypercar', price:220000, model:'uploads/mclaren-p1.glb',                     rotY:0, glow:0xff8a00, body:0x0a0a0a, stats:{speed:9.35, accel:10,  handling:8,   boost:10} },
    ...
    { id:'centodieci',             brand:'Bugatti',     name:'Centodieci',                 tier:'hypercar', price:230000, model:'uploads/bugatti-centodieci.glb',             rotY:0, glow:0xf2f2f2, body:0x101010, stats:{speed:9.93, accel:9.8, handling:8,   boost:9.9} },
